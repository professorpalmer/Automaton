...
| Id | Where | What parks |
| --- | --- | --- |
| `spring-lease` | `src/resting-motion.ts` + vendored `@gpuix/react` motion-spring | `onFrame` / `stepSpringLease` + 420ms hard park unsubscribe at rest; px integer + opacity subpixel publish |

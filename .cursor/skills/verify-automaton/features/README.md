...
Automaton GPUIX staff. Isolated from Marionette Home and ToyVendor boxes.

## Features

- [Staff rail](./rail.md)
- [Send while a job flies](./send-stays-send.md)
- [Fan-out confirm](./fanout.md)
- [Durable Staff mouth](./mouth-durable.md)
